...
public class NeuralFloppyTool1_9_2 {
    ...
    public static void saveToColumn(String column, String data, String format) {
        try {
    ...
    public static String askLLM(String query, JsonObject state) {
        try {
            if (currentMode == Mode.API) {
                return askAPI(query);
            } else if (currentMode == Mode.LOCAL) {
    ...
    public static String analyzeWithLLM(String query, JsonObject state) {
        try {
